...
extern void runJsonUtilsTests();
extern void runHttpClientTests();
extern void runSimulationRunnerUnitTests();
...
int main() {
    ...
    printf("\n");
    runSimulationRunnerUnitTests();

    printf("\n");
    runCoverageGapTests();

    printf("\n");
    runEventStreamServerTests();
    ...
    printf("\n");
    runCoverageBoostTests();

    printf("\n");
    runComponentMethodTests();
